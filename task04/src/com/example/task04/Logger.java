...
public class Logger {
    ...
    public Logger(String name, MessageHandler messageHandler, int current_level) {
    ...
    public Logger(String name, MessageHandler messageHandler) {
        this(name, messageHandler, 3);
    }

    public Logger(String name) {
        this(name, new ConsoleHandler(), 3);
    }
    ...
    private void printMessage(String level, String message) {
        messageHandler.log(String.format("[%s] %04d.%02d.%02d %02d:%02d:%02d %s - %s%n",
                level,
